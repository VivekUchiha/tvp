...
CPU::CPU(
    ...
    : a(std::move(a)), b(std::move(b)), c(std::move(c)), d(std::move(d)),
      ...
      opcode_map({
          ...
          /* 0x07 */ [&] { op_rlc_a(); },
          /* 0x08 */ [&] { op_ld_dbl(Address{get_inst_dbl()}, this->sp->get()); },
          ...
          /* 0x32 */ [&] { op_ldd_addr(Address{this->hl->get()}, this->a->get()); },
          /* 0x33 */ [&] { op_inc_dbl(this->sp.get()); },
          /* 0x34 */ [&] { op_inc(Address{this->hl->get()}); },
          /* 0x35 */ [&] { op_dec(Address{this->hl->get()}); },
          /* 0x36 */ [&] { op_ld(Address{this->hl->get()}, get_inst_byte()); },
          /* 0x37 */ [&] { op_scf(); },
          ...
          /* 0x70 */ [&] { op_ld(Address{this->hl->get()}, this->b->get()); },
          /* 0x71 */ [&] { op_ld(Address{this->hl->get()}, this->c->get()); },
          /* 0x72 */ [&] { op_ld(Address{this->hl->get()}, this->d->get()); },
          /* 0x73 */ [&] { op_ld(Address{this->hl->get()}, this->e->get()); },
          /* 0x74 */ [&] { op_ld(Address{this->hl->get()}, this->h->get()); },
          /* 0x75 */ [&] { op_ld(Address{this->hl->get()}, this->l->get()); },
          /* 0x76 */ [&] { op_halt(); },
          /* 0x77 */ [&] { op_ld(Address{this->hl->get()}, this->a->get()); },
          ...
          /* 0xe2 */ [&] { op_ld(Address{0xFF00 + this->c->get()}, this->a->get()); },
          /* 0xe3 */ [&] { /* UNDEFINED */ },
          /* 0xe4 */ [&] { /* UNDEFINED */ },
          /* 0xe5 */ [&] { op_push(this->hl.get()); },
          /* 0xe6 */ [&] { op_and(get_inst_byte()); },
          /* 0xe7 */ [&] { op_rst(0x20); },
          /* 0xe8 */ [&] { op_add_sp(int8_t{get_inst_byte()}); },
          /* 0xe9 */ [&] { op_jp(this->hl->get()); },
          /* 0xea */ [&] { op_ld_dbl(Address{get_inst_dbl()}, this->a->get()); },
          /* 0xeb */ [&] { /* UNDEFINED */ },
          /* 0xec */ [&] { /* UNDEFINED */ },
          /* 0xed */ [&] { /* UNDEFINED */ },
          ...
          /* 0xf7 */ [&] { op_rst(0x30); },
          /* 0xf8 */ [&] { op_ld_hl_sp_offset(int8_t{get_inst_byte()}); },
      ...
      cb_opcode_map({
          ...
          /* 0x06 */ [&] { op_rlc(Address{this->hl->get()}); },
          ...
          /* 0x0e */ [&] { op_rrc(Address{this->hl->get()}); },
          ...
          /* 0x16 */ [&] { op_rl(Address{this->hl->get()}); },
          ...
          /* 0x1e */ [&] { op_rr(Address{this->hl->get()}); },
          ...
          /* 0x26 */ [&] { op_sla(Address{this->hl->get()}); },
          ...
          /* 0x2e */ [&] { op_sra(Address{this->hl->get()}); },
          ...
          /* 0x36 */ [&] { op_swap(Address{this->hl->get()}); },
          ...
          /* 0x3e */ [&] { op_srl(Address{this->hl->get()}); },
